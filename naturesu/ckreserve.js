...
function fetchReservations(userId) {
    $.ajax({
        url: `https://naturesu.shop/reserve.php?user_id=${userId}`,
        type: 'GET',
        dataType: 'json',
...
function fetchReservations_admin(userId) {
    $.ajax({
        url: `https://naturesu.shop/reserve.php`,
        type: 'GET',
        dataType: 'json',
        success: function(reservations) {
            displayReservations(reservations);
...
function updateDeliveryStatus(reserve_id, newStatus) {
    ...
    fetch(`https://naturesu.shop/reserve.php/change?reservation_id=${reserve_id}`, requestOptions)
