...
async function fetchProductData(productId) {
    try {
        const response = await fetch(`https://naturesu.shop/product.php?id=${productId}`);
...
function sendReservation() {
    ...
    const url = `https://naturesu.shop/reserve.php`;
    // 서버로 예약 정보를 전송합니다.
    fetch(url, {
        method: 'POST',
        headers: {
...
function sendDeliver() {
    ...
    const url = `https://naturesu.shop/deliver.php`;
